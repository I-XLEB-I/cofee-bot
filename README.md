...
сводкой шести действующих точек. Продажи берутся из Telemetron, состояние связи
и время последней успешной оплаты — из Vendista. Архивная точка `Бел2`
остаётся в истории обслуживания, но не включается в оперативный блок. Если
онлайн-сервис временно недоступен, текущая информация об обслуживании
продолжает работать.
